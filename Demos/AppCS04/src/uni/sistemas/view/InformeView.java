...
public class InformeView extends javax.swing.JInternalFrame {
    ...
    public InformeView(String fileName) throws JRException {
        this(fileName, null);
    }

    public InformeView(String fileName, HashMap parameter) throws JRException {
        this();
        try {
            ...
            c.add(viewer);
        } catch (SQLException | ClassNotFoundException jre) {
        }
    }
