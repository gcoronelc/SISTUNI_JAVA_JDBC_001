...
public class productomanview extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtcodigo.setText("nulo");

        cbolinea.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1", "2", "3", "4", "5", "6", "7", "8", "9", " " }));

        btnAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uni/sistemas/imagen/save_all.png"))); // NOI18N
        ...
        btnModificar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uni/sistemas/imagen/contact-list.png"))); // NOI18N
        ...
        btnEliminar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uni/sistemas/imagen/Cancel.png"))); // NOI18N
        ...
        btnBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uni/sistemas/imagen/buscar.gif"))); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cbolinea, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE))
 ...
 private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
    ...
    private void mantenimiento(int op) {
        String msg = "";
        try {
            switch (op) {
                case 1:
                    leerDatos();
                    opro.ProductoRegistrar(pr);
                    msg = "Producto registrado con exito";
                    break;
                case 2:
                    leerDatos();
                    opro.ProductoActualiza(pr);
                    msg = "Producto actualizado con exito";
                    break;
                case 3:
                    pr.setIdproducto(txtcodigo.getText());
                    opro.ProductoEliminar(pr);
    ...
    private void leerDatos() {
        ...
        pr.setIdlinea(cbolinea.getSelectedIndex() + 1);
    ...
    private void buscar() throws Exception {
        pr = opro.ProductoBuscar(txtcodigo.getText());
        if (pr != null) {
            txtnombre.setText(pr.getNombre());
            cbolinea.setSelectedIndex(pr.getIdlinea() - 1);
